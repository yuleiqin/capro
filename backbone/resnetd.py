...
__all__ = ['ResNetD', 'resnetD18', 'resnetD34', 'resnetD50', 'resnetD101',
           'resnetD152', 'resnext50_32x4d', 'resnext101_32x8d',
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=True,
        ...
        self.num_out_channel = 512 * block.expansion
...
def resnetD18(pretrained=False, progress=True, **kwargs):
...
def resnetD34(pretrained=False, progress=True, **kwargs):
...
def resnetD50(pretrained=False, progress=True, **kwargs):
...
def resnetD101(pretrained=False, progress=True, **kwargs):
...
def resnetD152(pretrained=False, progress=True, **kwargs):
...
if __name__ == "__main__":
    ...
    model = resnetD50(pretrained=False, num_classes=1000)
    print(model)
    output = model(image)
    print(output.shape)
