...
export SAVE_DIR_NAME=web-nuswide-pretrained
...
python3.9 -W ignore -u train.py --seed 1024 --use_meta_weights 0 \
...
--arch "resnet50" --workers 16 --epochs 100 --frozen_encoder_epoch 0 \
--init-proto-epoch 100 --start_clean_epoch 101 --batch-size ${N_BATCHSIZE} \
--lr 2e-3 --cos --warmup_epoch 10 \
--exp-dir ${SAVE_DIR1} --start-epoch 0 \
--num-class ${N_CLASSES} --low-dim 128 \
--moco_queue 8192 --pseudo_th 0.9 \
