...
export resume_path=vanilla_ckpt/WebVision_vanilla.tar
...
--arch "resnet50" --workers 8 --epochs 60 --frozen_encoder_epoch 5 \
--init-proto-epoch 5 --start_clean_epoch 10 --batch-size ${N_BATCHSIZE} \
--topk 50 --lr 1e-1 --cos --warmup_epoch 5 --beta 0.1 \
